...
function FSTree(options) {
  ...
  this.entries = new Set((options.entries || []).slice());
}
...
FSTree.prototype.calculatePatch = function (_files) {
  ...
  if (this.entries) {
    ...
    var tree = new Tree(this.entries.values)
...
function Entries(entries) {
  ...
  function updateEntries(updates) {
    ...
    if (ul === el) {
      ...
      throw new Error('[Removals Encountered]: The length of updates was greater than the previous entries.');
    } else {
      throw new Error('[Additions Encountered]: The length of updates was greater than the previous entries.');
    }
  }
  ...
  function addEntries(additions) {
    ...
    if (al > el) {
      ...
      throw new Error('[Removals Encountered]: The length of removals was greater than the previous entries.');
    } else {
      throw new Error('[Updates Encountered]: The length of removals was the same as the previous entries.');
    }
  }
  ...
  function removeEntries(removals) {
    ...
    if (rl < el) {
      ...
      throw new Error('[Additions Encountered]: The length of removals was greater than the previous entries.');
    } else {
      throw new Error('[Updates Encountered]: The length of removals was the same as the previous entries.');
    }
  }
